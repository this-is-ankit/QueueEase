    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <ScrollView className="flex-1 px-6 pt-6">
        ...
        <View className="items-center mb-8">
          ...
          <Text className="text-xl font-bold text-textPrimary">{user?.name || 'Admin User'}</Text>
          <Text className="text-textSecondary">{user?.email || user?.phone || 'admin@queueease.com'}</Text>
        ...
        <View className="bg-gray-50 rounded-2xl p-6 mb-8">
          <Text className="text-sm font-bold text-textSecondary uppercase tracking-wider mb-4">Account Information</Text>
          ...
          <View className="flex-row justify-between mb-4 pb-4 border-b border-gray-200">
            <Text className="text-textSecondary">Phone Number</Text>
            <Text className="text-textPrimary font-medium">{user?.phone}</Text>
          </View>

          {user?.email && (
            <View className="flex-row justify-between">
              <Text className="text-textSecondary">Email Address</Text>
        ...
        <View className="mb-10">
           <TouchableOpacity className="flex-row items-center py-4 border-b border-gray-100">
              ...
              <Text className="flex-1 text-textPrimary text-base font-medium">Settings</Text>
              <Text className="text-textSecondary">›</Text>
           </TouchableOpacity>
           
           <TouchableOpacity className="flex-row items-center py-4 border-b border-gray-100">
              <Text className="text-lg mr-3">🛡️</Text>
              <Text className="flex-1 text-textPrimary text-base font-medium">Privacy & Security</Text>
              <Text className="text-textSecondary">›</Text>
           </TouchableOpacity>

           <TouchableOpacity className="flex-row items-center py-4">
              <Text className="text-lg mr-3">❓</Text>
              <Text className="flex-1 text-textPrimary text-base font-medium">Help & Support</Text>
              <Text className="text-textSecondary">›</Text>
           </TouchableOpacity>
        </View>
